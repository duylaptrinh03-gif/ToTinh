        ...
        {memories.map((memory, index) => (
          ...
          >
            <div className="w-full md:w-1/2 flex justify-center">
              <div className="relative w-full md:w-10/12 rounded-2xl overflow-hidden shadow-xl border-4 border-white transform md:rotate-2 md:hover:rotate-0 transition-transform duration-300 bg-gray-50">
            ...
            <div className="w-full md:w-1/2 bg-white/60 backdrop-blur-sm p-6 rounded-2xl shadow-lg">
              <h3 className="text-2xl font-bold text-gray-800 mb-3 text-pink-600">{memory.title}</h3>
